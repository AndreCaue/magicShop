...
import { VerifyDialog } from "@/Pages/Home/Components/VerifyDialog";
...
export default function OrderReview({
  ...
  const { items, subtotal, discount, cart } = useCart();
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      /* Fazer logica para decrementar temporariamente, utilizar o stoque reservado e para decrementar e colocar produto como sem estoque.   */
  ...
  return (
    <>
      ...
      {isOpen && <VerifyDialog isOpen={isOpen} setIsOpen={setOpen} />}
    </>
  );
}
